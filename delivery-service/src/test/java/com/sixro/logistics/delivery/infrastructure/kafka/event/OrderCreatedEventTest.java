...
class OrderCreatedEventTest {
    ...
    @Test
    void serializeOccurredAtAsIsoString() throws Exception {
        ...
        assertThat(json.path("occurredAt").asText()).isEqualTo("2026-08-12T13:48:28.5382411");
    }
    ...
    void deserializeCommonEnvelope() throws Exception {
        String json = """
                {
                  ...
                  "occurredAt": "2026-08-11T03:10:00.5382411",
                  "data": {
        ...
        assertThat(event.occurredAt()).isEqualTo(
                LocalDateTime.of(2026, 8, 11, 3, 10, 0, 538_241_100)
        );
